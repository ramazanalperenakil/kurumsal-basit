...
$('.cln-service-activation').slick({
    ...
    arrows: true,
    focusOnSelect: true,
    prevArrow: '<button  type="button"  class="clnService-prev"><i class="fa fa-angle-left"></i></button>',
    nextArrow: '<button  type="button"  class="clnService-next"><i class="fa fa-angle-right"></i></button>',
...
$('.testimonial-carousel-3').slick({
    ...
    focusOnSelect: true,
    centerPadding: '0',
    prevArrow: '<button  type="button"  class="post-prev"><i class="fa fa-angle-left"></i></button>',
    nextArrow: '<button  type="button"  class="post-next"><i class="fa fa-angle-right"></i></button>',
