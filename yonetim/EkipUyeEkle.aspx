<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EkipUyeEkle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Ekip Üye Ekle</h1>
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonYayınla" CssClass="btn btn-primary" runat="server" Text="Ekip Üye Ekle" OnClick="ButtonYayınla_Click"  />
