<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ayar.aspx.cs" Inherits="yonetim_Default" %>
        ...
        <div class="page-container2">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxSiteAdi" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Site Slogan</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextSiteSlogan"  CssClass="form-control" runat="server"></asp:TextBox>
                      ...
                      <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Site Açıklama</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextSiteAciklama"  CssClass="form-control" runat="server"></asp:TextBox>
                         
                        </div>
                    </div>
                            <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Site Anahtar Kelime</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxTSiteAnahtarKelime"  CssClass="form-control" runat="server"></asp:TextBox>
                         
                        </div>
                    </div>
                            <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Site URL</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxSiteUrl"  CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="file-input" class=" form-control-label">Logo Yükle</label>
                        </div>
                        <div class="col-12 col-md-9">
                    ...
                    <div class="row form-group mt-2">
                        ...
                        <div class="col-12 col-md-9 mt-2">
                            ...
                            <asp:Image ID="ImageYuklene" CssClass="fluid" height="350" width="350" runat="server"  />
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonYayınla" CssClass="btn btn-primary" runat="server" Text="Kaydet" OnClick="ButtonYayınla_Click"   />
