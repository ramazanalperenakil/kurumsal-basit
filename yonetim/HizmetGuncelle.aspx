<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HizmetGuncelle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Hizmet Güncelle</h1>
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxHizmetAdi" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hizmet Kısa Açıklama</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxHizmetKisaAciklama" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                         <script type="text/javascript">
                                CKEDITOR.replace('TextBoxHizmetKisaAciklama',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 300}});
                       ...
                       <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hizmet Uzun Açıklama</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxUzunAciklama" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                          <script type="text/javascript">
                                CKEDITOR.replace('TextBoxUzunAciklama',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false}});
