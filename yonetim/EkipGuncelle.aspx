<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EkipGuncelle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Ekip Üyesi Güncelleme</h1>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label"> Adı ve Soyadı</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxAdSoyad" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Görevi</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxGörevi"  CssClass="form-control" runat="server"></asp:TextBox>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxFacebook"  CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxInstagram"  CssClass="form-control" runat="server"></asp:TextBox>
                         
                        </div>
                    </div>
                            <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Diğer</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxDiger"  CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="file-input" class=" form-control-label">Üye Fotoğrafı</label>
                        </div>
                        <div class="col-12 col-md-9">
                    ...
                    <div class="row form-group mt-2">
                        ...
                        <div class="col-12 col-md-9 mt-2">
                            ...
                            <asp:Image ID="ImageYuklene" CssClass="fluid" height="350" width="350" runat="server" Visible="false" />
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonYayınla" CssClass="btn btn-primary" runat="server" Text="Ekip Üye Güncelle" OnClick="ButtonYayınla_Click"  />
