<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EkipDuzenle.aspx.cs" Inherits="yonetim_Default" %>
                        ...
                        <table class="table table-data2">
                            <thead>
                                <tr>
                                    ...
                                    <th>İd</th>
                                    <th>Ekip Üye Resim</th>
                                    <th>Ekip Üye Adı ve Soyadı</th>
                                    <th>Ekip Üye Görevi</th>
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterEkip" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <td><%#Eval("Ekip_İd")%></td>
                                            <td>
                                                <img src="<%#Eval("Ekip_Uye_Resim_Url")%>" />
                                            </td>
                                            <td class="desc">
                                               <%#Eval("Ekip_Uye_Adi")%>
                                            ...
                                            <td><%#Eval("Ekip_Uye_Gorevi")%></td>

                                            <td>
                                                <div class="table-data-feature">
                                                   
                                                    <a href="EkipGuncelle.aspx?Id=<%#Eval("Ekip_İd")%>" class="btn btn-success m-2">Düzenle
                                                      
                                                    </a>
                                                    
                                                    <a href="EkipDuzenle.aspx?Id=<%#Eval("Ekip_İd")%>&islem=sil" class="btn btn-danger m-2" onclick="return confirm('Kayıt Silmek İstediğinizden Emin Misiniz ? ' )">Sil
