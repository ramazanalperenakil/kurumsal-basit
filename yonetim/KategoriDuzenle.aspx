<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KategoriDuzenle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Kategori Düzenle</h1>
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterKategoriler" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <td><%#Eval("Kategori_Url")%></td>

                                            <td>
                                                <div class="table-data-feature">
                                                   
                                                    <a href="KategoriGuncelle.aspx?Id=<%#Eval("Kategori_Id")%>" class="btn btn-success m-2">Düzenle
                                                      
                                                    </a>
                                                    
                                                    <a href="KategoriDuzenle.aspx?Id=<%#Eval("Kategori_Id")%>&islem=sil" class="btn btn-danger m-2" onclick="return confirm('Kayıt Silmek İstediğinizden Emin Misiniz ? ' )">Sil
