...
public partial class yonetim_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["Id"] != null && Request.QueryString["islem"] == "sil")
        {
            ...
            try
            {
                kod.komut("delete from kategoriler where Kategori_Id=" + Request.QueryString["Id"].ToString());

                MessageBox.Show("İşlem Başarılı.<br/> Kategori Silindi", MessageBox.MesajTipleri.Success);
            }
            catch
            {
