<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HakkimizdaDuzenle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Hakkımızda Düzenle</h1>
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hakkımızda Başlık</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxHakkimizdaBaslik" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hakkımızda Kısa Metin</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxHakkimizdaKisaMetin" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                         <script type="text/javascript">
                                CKEDITOR.replace('TextBoxHakkimizdaKisaMetin',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 1000}});
                       ...
                       <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hakkımızda Uzun Metin</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxHakkimizdaUzunMetin" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                         <script type="text/javascript">
                                CKEDITOR.replace('TextBoxHakkimizdaUzunMetin',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,}});
                     ...
                     <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hakkımızda Sayfa Url</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxHakkimizdaSayfaUrl" CssClass="form-control" runat="server"></asp:TextBox>
