<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hizmetler.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Hizmetler Düzenle</h1>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="hf-email" class=" form-control-label">Hizmet Sayfa Başlık</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <asp:TextBox ID="TextBoxHizmetSayfaAdi" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="hf-password" class=" form-control-label">Hizmet Sayfası Açıklama Metni</label>
                            </div>
                            <div class="col-12 col-md-9">
                                  <asp:TextBox ID="TextBoxHizmetSayfasiAciklama" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                                 <script type="text/javascript">
                                CKEDITOR.replace('TextBoxHizmetSayfasiAciklama',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 300}});
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonSayfaBilgisiGüncelle" CssClass="btn btn-primary btn-sm" runat="server" Text="Sayfa Bilgisi Güncelle" OnClick="ButtonSayfaBilgisiGüncelle_Click" />
                        ...
                        <table class="table table-data2">
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterHizmetler" runat="server">
                                        <ItemTemplate>
                                            <tr class="tr-shadow">
                                            <td><%#Eval("Hizmet_İd")%></td>
                                            <td>
                                                <img src="<%#Eval("Hizmet_Resim_Url")%>" />
                                            </td>
                                            <td class="desc">
                                               <%#Eval("Hizmet_Adi")%>
                                            ...
                                            <td><%#Eval("Hizmet_Kisa_Aciklama")%></td>

                                            <td>
                                                <div class="table-data-feature">
                                                   
                                                    <a href="HizmetGuncelle.aspx?Id=<%#Eval("Hizmet_İd")%>" class="btn btn-success m-2">Düzenle
                                                      
                                                    </a>
                                                    
                                                    <a href="Hizmetler.aspx?Id=<%#Eval("Hizmet_İd")%>&islem=sil" class="btn btn-danger m-2" onclick="return confirm('Kayıt Silmek İstediğinizden Emin Misiniz ? ' )">Sil
