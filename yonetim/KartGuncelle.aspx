<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KartGuncelle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Kart Güncelle Sayfalar</h1>
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Kart Başlık</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxKartBaslik" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Kart Metin</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxKartMetin" TextMode="MultiLine" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                           
                            <script type="text/javascript">
                                CKEDITOR.replace('TextBoxKartMetin',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 150}});
