<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hesap.aspx.cs" Inherits="yonetim_Default" %>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div class="text-center">
                            <asp:Image ID="resim1" ImageUrl="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" CssClass="img-fluid mt-5" runat="server" />
                           <br />
                         <br />   <h6>Profil Fotoğrafı Yükleyiniz...</h6><br />
                            <asp:FileUpload ID="fuDosya" ClientIDMode="Static" onchange="$('#resim1')[0].src = window.URL.createObjectURL(this.files[0])"  runat="server" Width="100%" Height="35px" />
                        </div>
                        <br>
                    </div>
                    <!--/col-3-->
                            ...
                            <div class="tab-pane active" id="home">
                                <hr>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <label for="mobile">
                                              ...
                                              <asp:TextBox ID="TextBoxEPosta" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <br>
                                            <asp:Button CssClass="btn btn-lg btn-success" ID="ButtonKaydet" runat="server" Text="Kaydet" OnClick="ButtonKaydet_Click" />
