<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlogDuzenle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Makale Düzenle</h1>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label   class=" form-control-label">Blog Sayfa Başlık</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <asp:TextBox ID="TextBlogleSayfaAdi" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label class=" form-control-label">Blog Sayfası Açıklama Metni</label>
                            </div>
                            <div class="col-12 col-md-9">
                                  <asp:TextBox ID="TextBoxBlogSayfasiAciklama" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>

                                <script type="text/javascript">
                                CKEDITOR.replace('TextBoxBlogSayfasiAciklama',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 300}});
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonSayfaBilgisiGüncelle" CssClass="btn btn-primary btn-sm" runat="server" Text="Sayfa Bilgisi Güncelle"  />
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterBlog" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <td><%#Eval("Blog_Id")%></td>
                                            <td>
                                                <img src="<%#Eval("Blog_Kucuk_Resim_Url")%>" />
                                            </td>
                                            <td class="desc">
                                               <%#Eval("Blog_Yazi_Basligi")%>
                                            ...
                                            <td>
                                                ...
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="MakaleGuncelle.aspx?Id=<%#Eval("Blog_Id")%>" class="btn btn-success m-2">Düzenle
                                                      
                                                    </a>
                                                    
                                                    <a href="BlogDuzenle.aspx?Id=<%#Eval("Blog_Id")%>&islem=sil" class="btn btn-danger m-2" onclick="return confirm('Kayıt Silmek İstediğinizden Emin Misiniz ? ' )">Sil
