<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlogYaziEkle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Blog Yazısı Ekle</h1>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Makale Başlık</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxBlogYaziBaslik" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Makale Kısa Metin Max:250 Karakter</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxMakaleKisaMetin" data-maxlen="250" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                             <script type="text/javascript">
                                CKEDITOR.replace('TextBoxMakaleKisaMetin',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 300}});
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Makale Uzun Metin</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxMakaleUzunMetin" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                             <script type="text/javascript">
                                CKEDITOR.replace('TextBoxMakaleUzunMetin',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false}});
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Makale Kategori</label>
                        </div>
                        <div class="col col-md-3">
                            <asp:DropDownList CssClass="form-control" ID="DropDownListKategori" runat="server"></asp:DropDownList>
                        </div>
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonYayınla" CssClass="btn btn-primary" runat="server" Text="Yayınla" OnClick="ButtonYayınla_Click" />
