<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ayricaliklar.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Ayrıcalıklar Düzenle</h1>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="hf-email" class=" form-control-label">Ayrıcalık Genel Başlık</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <asp:TextBox ID="TextBoxAyricalikGenelBaslik" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="hf-password" class=" form-control-label">Ayrıcalık Genel Kısa Açıklama</label>
                            </div>
                            <div class="col-12 col-md-9">
                                  <asp:TextBox ID="TextBoxAyricaklikGenelMetin" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>

                                 <script type="text/javascript">
                                CKEDITOR.replace('TextBoxAyricaklikGenelMetin',{wordcount: {showParagraphs: true,showWordCount: true,showCharCount: true,countSpacesAsChars:true,countHTML:false,maxCharCount: 300}});
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonAricalikGenelBilgisiGüncelle" CssClass="btn btn-primary btn-sm" runat="server" Text="Ayrıcalık Genel Bilgi Güncelle" OnClick="ButtonAricalikGenelBilgisiGüncelle_Click" />
                    ...
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2">
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterAyrıcalıklar" runat="server">
                                        <ItemTemplate>
                                            <tr class="tr-shadow">
                                            <td><%#Eval("Ayricaliklar_İd")%></td>
                                            <td>
                                                <img src="<%#Eval("Ayricalik_İcon_Url")%>" />
                                            </td>
                                            <td class="desc">
                                               <%#Eval("Ayricalik_Adi")%>
                                            ...
                                            <td><%#Eval("Ayricalik_Metin")%></td>

                                            <td>
                                                <div class="table-data-feature">
                                                   
                                                    <a href="AyricalikGuncelle.aspx?Id=<%#Eval("Ayricaliklar_İd")%>" class="btn btn-success m-2">Düzenle
