<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SliderDuzenle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Slider Düzenle</h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="rs-select2--light rs-select2--md ml-5">
                                <asp:DropDownList CssClass="form-control" ID="DropDownListYayinDurumunaGore" runat="server" AutoPostBack="True">

                                    <asp:ListItem Value="1">Aktif</asp:ListItem>
                                    <asp:ListItem Value="0">Pasif</asp:ListItem>
                                    <asp:ListItem Value="2" Selected="true">Tümü</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <a href="SliderEkle.aspx" class="au-btn au-btn-icon au-btn--green au-btn--small ml-2">
                                <i class="zmdi zmdi-plus"></i>Slider Ekle</a>
                        </div>
                        ...
                        <table class="table table-data2">
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterSlider" runat="server">
                                        <ItemTemplate>
                                            <tr class="tr-shadow">
                                            <td><%#Eval("Slider_Id")%></td>
                                            <td>
                                                <img src="<%#Eval("Slider_Gorsel_Url")%>" alt="<%#Eval("Slider_Hedef_Url")%>" />
                                            </td>
                                            <td class="desc">
                                                <%# Eval("Slider_Durum").ToString() == "0" ? "Pasif Özellik" : Eval("Slider_Durum").ToString() == "1" ? "Aktif " : "" %>
                                        

                                            </td>
                                            <td><%#Eval("Slider_Hedef_Url")%></td>

                                            <td>
                                                <div class="table-data-feature">
                                                    
     
                                                    <a href="SliderDuzenle.aspx?Id=<%#Eval("Slider_Id")%>&islem=yayindankaldir" class="btn btn-info m-2">Yayından Kaldır
                                                      
                                                    </a>
                                                   
                                                    <a href="SliderGuncelle.aspx?Id=<%#Eval("Slider_Id")%>" class="btn btn-success m-2">Düzenle
                                                      
                                                    </a>
                                                    
                                                    <a href="SliderDuzenle.aspx?Id=<%#Eval("Slider_Id")%>&islem=sil" class="btn btn-danger m-2" onclick="return confirm('Kayıt Silmek İstediğinizden Emin Misiniz ? ' )">Sil
