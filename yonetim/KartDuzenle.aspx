<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KartDuzenle.aspx.cs" Inherits="yonetim_Default" %>
                    ...
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2">
                            ...
                            <tbody>
                                    ...
                                    <asp:Repeater ID="RepeaterKart" runat="server">
                                        <ItemTemplate>
                                            <tr class="tr-shadow">
                                            <td><%#Eval("Kart_Id")%></td>
                                            <td>
                                                <img src="<%#Eval("Kart_Icon_Url")%>"  />
                                            </td>
                                            <td class="desc">
                                                <%# Eval("Kart_Baslik") %>
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="KartGuncelle.aspx?Id=<%#Eval("Kart_Id")%>" class="btn btn-success m-2">Düzenle
