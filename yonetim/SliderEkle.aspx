<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SliderEkle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5 text-center">Slider Ekle</h1>
            <asp:Panel ID="PanelBasarili" Visible="false" runat="server">
            ...
            <asp:Panel ID="PanelHata" Visible="false" runat="server">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Hedef Url</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox ID="TextBoxSliderHedefUrl" CssClass="form-control" runat="server"></asp:TextBox>

                            <small class="form-text text-muted">http:// veya https:// ile başlmalı</small>
                        </div>
                    </div>

                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="select" class=" form-control-label">Yayınlanma Durumu</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:DropDownList ID="DropDownListYayinDurumu" CssClass="form-control" runat="server">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <img id="resim" alt="Seçtiğiniz resim burada görünecek " class="img-fluid" height="350" width="350" />
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonYayınla" CssClass="btn btn-primary" runat="server" Text="Slider Kaydet" OnClick="ButtonYayınla_Click" />
