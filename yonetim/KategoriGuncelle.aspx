<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KategoriGuncelle.aspx.cs" Inherits="yonetim_Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="page-container2">
            ...
            <br />
            <h1 class="pt-5">Kategori Güncelle</h1>
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="hf-email" class=" form-control-label">Kategori Adı</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <asp:TextBox CssClass="form-control" ID="TextBoxKategoriAdi" runat="server"></asp:TextBox>
                ...
                <div class="card-footer">
                    <asp:Button ID="ButtonKaydet" CssClass="btn btn-primary " runat="server" Text="Kaydet" OnClick="ButtonKaydet_Click" />
